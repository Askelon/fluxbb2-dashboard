											...
											<table class="table">
												<tbody>
													<tr>
														...
														<td>
															<input class="form-control" type="text" name="form[board_title]" size="50" maxlength="255" value="OnEnAGros! − LE forum des fans de Kaamelott"></div>
															<p>The title of this bulletin board (shown at the top of every page). This field may <strong>not</strong> contain HTML.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Board description</th>
														<td>
															<input class="form-control" type="text" name="form[board_desc]" size="50" maxlength="255" value=""></div>
													...
													<tr>
														...
														<td>
															<input class="form-control" type="text" name="form[base_url]" size="50" maxlength="100" value="http://forum.onenagros.org"></div>
															<p>The complete URL of the board without trailing slash (i.e. http://www.mydomain.com/forums). This <strong>must</strong> be correct in order for all admin and moderator features to work. If you get "Bad referer" errors, it's probably incorrect.</p>
														</td>
													</tr>
													<tr>
														...
														<td class="form-inline">
															...
															<p>The default time zone for guests and users attempting to register for the board.</p>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td class="form-inline">
															...
															<p>The default language for guests and users who haven't changed from the default in their profile. If you remove a language pack, this must be updated.</p>
														</td>
													</tr>
													<tr>
														...
														<td class="form-inline">
															...
															<p>The default style for guests and users who haven't changed from the default in their profile.</p>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="table">
												<tbody>
													<tr>
														...
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[time_format]" size="25" maxlength="25" value="H:i:s"></div>
															<p>[Current format: 10:55:28]. See <a href="http://www.php.net/manual/en/function.date.php">PHP manual</a> for formatting options.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Date format</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[date_format]" size="25" maxlength="25" value="Y-m-d"></div>
															<p>[Current format: 2013-07-06]. See <a href="http://www.php.net/manual/en/function.date.php">PHP manual</a> for formatting options.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Visit timeout</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[timeout_visit]" size="5" maxlength="5" value="1800"></div>
															<p>Number of seconds a user must be idle before his/hers last visit data is updated (primarily affects new message indicators).</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Online timeout</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[timeout_online]" size="5" maxlength="5" value="300"></div>
															<p>Number of seconds a user must be idle before being removed from the online users list.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Redirect time</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[redirect_delay]" size="3" maxlength="3" value="1"></div>
															<p>Number of seconds to wait when redirecting. If set to 0, no redirect page will be displayed (not recommended).</p>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="table">
												<tbody>
													<tr>
														...
														<td>
															<label class="conl"><input type="radio" name="form[show_version]" value="1">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[show_version]" value="0" checked="checked">&nbsp;<strong>No</strong></label>
															<span class="clearb">Show FluxBB version number in footer.</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														<th scope="row">Smilies in posts</th>
														<td>
															<label class="conl"><input type="radio" name="form[smilies]" value="1" checked="checked">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[smilies]" value="0">&nbsp;<strong>No</strong></label>
															<span class="clearb">Convert smilies to small graphic icons.</span>
														</td>
													</tr>
													<tr>
														<th scope="row">Smilies in signatures</th>
														<td>
															<label class="conl"><input type="radio" name="form[smilies_sig]" value="1" checked="checked">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[smilies_sig]" value="0">&nbsp;<strong>No</strong></label>
															<span class="clearb">Convert smilies to small graphic icons in user signatures.</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[topic_review]" size="3" maxlength="3" value="15"></div>
															<p>Maximum number of posts to display when posting (newest first). Set to 0 to disable.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Topics per page</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[disp_topics_default]" size="3" maxlength="2" value="30"></div>
															<p>The default number of topics to display per page in a forum. Users can personalize this setting.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Posts per page</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[disp_posts_default]" size="3" maxlength="2" value="25"></div>
															<p>The default number of posts to display per page in a topic. Users can personalize this setting.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Indent size</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[indent_num_spaces]" size="3" maxlength="3" value="4"></div>
															<p>If set to 8, a regular tab will be used when displaying text within the [code][/code] tag. Otherwise this many spaces will be used to indent the text.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Maximum [quote] depth</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[quote_depth]" size="3" maxlength="3" value="3"></div>
															<p>The maximum times a [quote] tag can go inside other [quote] tags, any tags deeper than this will be discarded.</p>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="table">
												<tbody>
													<tr>
														...
														<td>
															<label class="conl"><input type="radio" name="form[quickpost]" value="1" checked="checked">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[quickpost]" value="0">&nbsp;<strong>No</strong></label>
															<span class="clearb">When enabled, FluxBB will add a quick post form at the bottom of topics. This way users can post directly from the topic view.</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														<th scope="row"><a name="censoring"></a>Censor words</th>
														<td>
															<label class="conl"><input type="radio" name="form[censoring]" value="1">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[censoring]" value="0" checked="checked">&nbsp;<strong>No</strong></label>
															<span class="clearb">Enable this to censor specific words in the board. See <a href="admin_censoring.php">Censoring</a> for more info.</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															<label class="conl"><input type="radio" name="form[quickjump]" value="1" checked="checked">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[quickjump]" value="0">&nbsp;<strong>No</strong></label>
															<span class="clearb">Enable the quick jump (jump to forum) drop list.</span>
														</td>
													</tr>
													<tr>
														<th scope="row">GZip output</th>
														<td>
															<label class="conl"><input type="radio" name="form[gzip]" value="1">&nbsp;<strong>Yes</strong></label>
															<label class="conl"><input type="radio" name="form[gzip]" value="0" checked="checked">&nbsp;<strong>No</strong></label>
															<span class="clearb">If enabled, FluxBB will gzip the output sent to browsers. This will reduce bandwidth usage, but use a little more CPU. This feature requires that PHP is configured with zlib (--with-zlib). Note: If you already have one of the Apache modules mod_gzip or mod_deflate set up to compress PHP scripts, you should disable this feature.</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															<textarea class="form-control" name="form[additional_navlinks]" rows="3" cols="55">3 = &lt;a href="http://forum.onenagros.org/topics.php" data-original-title="Discussions"&gt;&lt;i class="icon-archive"&gt;&lt;/i&gt;&lt;/a&gt;</textarea>
												...
												<tbody>
													...
													<tr>
														...
														<td class="form-inline">
															...
															<p>Feeds can be cached to lower the resource usage of feeds.</p>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="table">
												<tbody>
													...
													<tr>
														...
														<td>
															<textarea class="form-control" name="form[mailing_list]" rows="5" cols="55">webmaster@onenagros.org</textarea>
												...
												<tbody>
													<tr>
														...
														<td>
															...
															<p class="clearb">When enabled, users will be able to upload an avatar which will be displayed under their title.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Upload directory</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[avatars_dir]" size="35" maxlength="50" value="img/avatars"></div>
															<p>The upload directory for avatars (relative to the FluxBB root directory). PHP must have write permissions to this directory.</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Max width</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[avatars_width]" size="5" maxlength="5" value="140"></div>
															<p>The maximum allowed width of avatars in pixels (60 is recommended).</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Max height</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[avatars_height]" size="5" maxlength="5" value="140"></div>
															<p>The maximum allowed height of avatars in pixels (60 is recommended).</p>
														</td>
													</tr>
													<tr>
														<th scope="row">Max size</th>
														<td class="form-inline">
															<div class="form-group"><input class="form-control" type="text" name="form[avatars_size]" size="6" maxlength="6" value="32000"></div>
															<p>The maximum allowed size of avatars in bytes (10240 is recommended).</p>
														</td>
													</tr>
												</tbody>
											</table>
											...
											<table class="table">
												<tbody>
													...
													<tr>
														...
														<td>
															<textarea class="form-control" name="form[rules_message]" rows="10" cols="55"></textarea>
										...
										<div class="infldset">
											<table class="table">
												...
												<tr>
													...
													<td>
														<textarea class="form-control" name="form[announcement_message]" rows="5" cols="55"></textarea>
											...
											<table class="table">
												<tbody>
													    ...
													    <tr>
														    ...
														    <td>
															    <textarea class="form-control" name="form[maintenance_message]" rows="5" cols="55"></textarea>
