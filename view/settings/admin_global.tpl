						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" name="form[base_url]" size="50" maxlength="100" value="http://forum.onenagros.org">
						...
						<div class="infldset">
							<table class="table">
								...
								<tr>
									...
									<td>
										<input type="text" name="form[indent_num_spaces]" size="3" maxlength="3" value="4">
								...
								<tr>
									...
									<td>
										<input type="text" name="form[quote_depth]" size="3" maxlength="3" value="3">
						...
						<div class="infldset">
							<table class="table">
								...
								<tr>
									...
									<td>
										<textarea name="form[additional_navlinks]" rows="3" cols="55">3 = &lt;a href="http://forum.onenagros.org/topics.php" data-original-title="Discussions"&gt;&lt;i class="icon-archive"&gt;&lt;/i&gt;&lt;/a&gt;</textarea>
