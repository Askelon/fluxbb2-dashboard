    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-success btn-mini">Install 1.6.0</button>
              <button class="btn btn-warning btn-mini">Remove</button>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-success btn-mini">Install 5.0.0</button>
              <button class="btn btn-warning btn-mini">Remove</button>
            </div>
          </td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-success btn-mini">Install 1.5.3</button>
              <button class="btn btn-warning btn-mini">Remove</button>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-success btn-mini">Install 1.0.2</button>
              <button class="btn btn-warning btn-mini">Remove</button>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-success btn-mini">Install 1.1.4</button>
              <button class="btn btn-warning btn-mini">Remove</button>
            </div>
          </td>
        </tr>
