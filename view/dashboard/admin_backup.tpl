        ...
        <div class="row-fluid">
          ...
          <div class="span4 dashbox-backup">
            ...
            <div class="dashbox">
              ...
              <p class="text-center">
                <a href="#" class="btn btn-mini btn-success">Download again <i class="icon-download-alt"></i></a> or 
                <a href="#" class="btn btn-mini btn-info">Generate new backup <i class="icon-download-alt"></i></a>
                <small><small>New backup is recommended.</small></small>
              </p>
            </div>
          </div>
          ...
          <div class="tabbable tabs-left" style="margin-bottom: 18px;">
            ...
            <div class="tab-content" style="">
              ...
              <div class="tab-pane" id="tab2">
                ...
                <select multiple class="pull-left">
