		...
		<div class="main">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 dashbox-report">
					...
					<div class="col-md-4 dashbox-stats">
						<h4>Statistics</h4>
						<div class="row dashbox">
							...
							<div class="col-md-4 text-center divide">
				...
				<div class="row">
					...
					<div class="col-md-4 dashbox-notes">
						<h4>Notes</h4>
						<div class="dashbox">
					...
					<div class="col-md-4 dashbox-backup">
						...
						<div class="dashbox">
							...
							<p>
								<a href="#" class="btn btn-xs btn-success">Download again <i class="icon-download-alt"></i></a>
								<a href="#" class="btn btn-xs btn-info">Generate new backup <i class="icon-download-alt"></i></a>
							</p>
							<hr />
						</div> <!-- /dashbox -->
					</div> <!-- /dashbox-notes -->

					<div class="col-md-4 dashbox-logs">
						<h4>Logs &amp; Notifications</h4>
						<div class="dashbox">
							<table class="table">
								<tbody>
									<tr class="info">
										<td><span class="label label-info"><i class="icon-info"></i></span></td>
